  ...
  <div class="container px-5 py-24 mx-auto flex flex-col">
    <div class="lg:w-4/6 mx-auto">
      <div class="rounded-lg h-full overflow-hidden">
        <img alt="content" class="object-cover object-center h-full w-full" src="{{$post->getFirstMediaUrl('featured_image') != ''? $post->getFirstMediaUrl('featured_image'): 'https://dummyimage.com/1200x500'}}">
      </div>
