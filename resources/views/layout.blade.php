...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
     ...
     class="w-100 h-10 p-full bg-transpant-500 rounded-full object-contain" /> </a>
        ...
        <a href="http://localhost:8000/admin/login" class="inline-flex items-center bg-gray-800 border-0 py-1 px-3 focus:outline-none hover:bg-gray-700 rounded text-base mt-4 md:mt-0">Login
